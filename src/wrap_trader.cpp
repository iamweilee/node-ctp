...
void WrapTrader::ReqUserLogout(const FunctionCallbackInfo<Value>& args) {
  ...
  strcpy(req.BrokerID, ((std::string) * brokerUtf8).c_str());
  strcpy(req.UserID, ((std::string) * userIdUtf8).c_str());
  logger_cout(log.append(" ").append((std::string) * brokerUtf8).append("|").append(
          (std::string) * userIdUtf8).c_str());
  ...
  *(cbArray + 1) = Boolean::New(isolate, data->bIsLast);
  if (data->rtnField){ 
    CThostFtdcInvestorPositionField* _pInvestorPosition = static_cast<CThostFtdcInvestorPositionField*>(data->rtnField);
		...
		jsonRtn->Set(String::NewFromUtf8(isolate, "PositionDate"), Number::New(isolate, _pInvestorPosition->PositionDate));
		jsonRtn->Set(String::NewFromUtf8(isolate, "YdPosition"), Number::New(isolate, _pInvestorPosition->YdPosition));
		jsonRtn->Set(String::NewFromUtf8(isolate, "Position"), Number::New(isolate, _pInvestorPosition->Position));
		jsonRtn->Set(String::NewFromUtf8(isolate, "LongFrozen"), Number::New(isolate, _pInvestorPosition->LongFrozen));
		jsonRtn->Set(String::NewFromUtf8(isolate, "ShortFrozen"), Number::New(isolate, _pInvestorPosition->ShortFrozen));
		...
		jsonRtn->Set(String::NewFromUtf8(isolate, "OpenVolume"), Number::New(isolate, _pInvestorPosition->OpenVolume));
		jsonRtn->Set(String::NewFromUtf8(isolate, "CloseVolume"), Number::New(isolate, _pInvestorPosition->CloseVolume));
		...
		jsonRtn->Set(String::NewFromUtf8(isolate, "SettlementID"), Number::New(isolate, _pInvestorPosition->SettlementID));
		...
		jsonRtn->Set(String::NewFromUtf8(isolate, "CombPosition"), Number::New(isolate, _pInvestorPosition->CombPosition));
		jsonRtn->Set(String::NewFromUtf8(isolate, "CombLongFrozen"), Number::New(isolate, _pInvestorPosition->CombLongFrozen));
		jsonRtn->Set(String::NewFromUtf8(isolate, "CombShortFrozen"), Number::New(isolate, _pInvestorPosition->CombShortFrozen));
		...
		jsonRtn->Set(String::NewFromUtf8(isolate, "TodayPosition"), Number::New(isolate, _pInvestorPosition->TodayPosition));
  ...
  *(cbArray + 1) = Boolean::New(isolate, data->bIsLast);
  if (data->rtnField){ 
    CThostFtdcInstrumentField *pInstrument = static_cast<CThostFtdcInstrumentField*>(data->rtnField);
		...
		jsonRtn->Set(String::NewFromUtf8(isolate, "InstLifePhase"), Number::New(isolate, pInstrument->InstLifePhase));
